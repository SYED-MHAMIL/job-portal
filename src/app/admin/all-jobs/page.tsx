...
:
      fetchAllJobs.length > 0 &&
        fetchAllJobs.map(({ jobTitle, jobDescription,jobType ,address,companyAllData,salaryRange,docId,qualification,hold,deleted}) => (
          <AdminCard key={docId} jobTitle={jobTitle} jobDescription={jobDescription} jobType={jobType} address={address} companyName={companyAllData.name} companyLogo={companyAllData.logo} salary={salaryRange} jobID={docId}   qualification={qualification
          }
          hold={hold}
          deleted={deleted}
