...
export default function AppliedJobCard({jobTitle, jobDescription ,jobType,address ,isFavourite}: JobCardType){
    ...
    <div className="flex flex-col justify-start">
      <div className="flex justify-between items-center">
        ...
        <span className="bg-green-500 rounded-full uppercase text-white text-sm px-4 py-1 font-bold shadow-xl"> {jobType} </span>
      </div>
      ...
      <div>
        <div className="mt-5">
     { !isFavourite?  <button disabled className="mr-2 my-1 uppercase tracking-wider px-2 text-indigo-600 border-indigo-600 hover:bg-indigo-600 hover:text-white border text-sm font-semibold rounded py-1 transition transform duration-500 cursor-pointer">Applied job!  </button>
     :<button disabled className="mr-2 my-1 uppercase tracking-wider px-2 text-indigo-600 border-indigo-600 hover:bg-indigo-600 hover:text-white border text-sm font-semibold rounded py-1 transition transform duration-500 cursor-pointer">Favourite job!</button>
